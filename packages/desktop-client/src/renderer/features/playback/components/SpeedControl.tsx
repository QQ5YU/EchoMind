  ...
  return (
    <div className="flex items-center justify-between pt-6 border-t border-gray-50">
      ...
      <select 
        ...
        className="bg-gray-50 border-none rounded-lg px-3 py-1.5 text-xs font-semibold text-gray-600 focus:ring-2 focus:ring-indigo-500 cursor-pointer outline-none"
      >
        {speeds.map(speed => (
