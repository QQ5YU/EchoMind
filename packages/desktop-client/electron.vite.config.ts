  ...
  main: {
    resolve: {
      alias: {
        ...
        "@core": resolve(__dirname, "../backend/src/core"),
        "@auth": resolve(__dirname, "../backend/src/auth"),
        "@transcripts": resolve(__dirname, "../backend/src/transcripts"),
        "@ai": resolve(__dirname, "../backend/src/ai"),
